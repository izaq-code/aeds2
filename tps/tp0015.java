...
public class tp0015 {
    ...
    /**
     * Implementação do Selection Sort para ordenar por título
     */
    public static void selectionSort(Show[] vetor, int n) {
        for (int i = 0; i < n - 1; i++) {
            int minIndex = i;
            for (int j = i + 1; j < n; j++) {
                comparacoes++;
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Impressão dos 10 primeiros resultados ordenados
